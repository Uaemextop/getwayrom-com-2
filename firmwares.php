...
<html lang="en">
   <head>
      ...
      <title>LE8-H771B-R-GL-220902V1114.zip | Firmware Download | Getwayrom</title>
      <meta name="keywords" content=""/>
      <meta name="description" content=""/>
      <meta property="og:title" content="LE8-H771B-R-GL-220902V1114.zip | Getwayrom - IMEI REPAIR, FRP REMOVAL, CARRIER UNLOCK">
...
<body>
                  ...
                  <ul class="page_breadcum_list" style="list-style: none; padding: 0; margin: 0; display: flex; flex-wrap: wrap; align-items: center; font-weight: bold;">
                     ...
                     <li onClick="window.location='firmware.php?cat=12&sub=1397'" style="cursor: pointer; display: inline-block; font-weight: bold;">
                        Tecno New Model Rom                     </li>
                                                               <li style="display: inline-block; margin: 0 8px; color: #666;">&gt;</li>
                     <li onClick="window.location='firmware.php?cat=12&sub=1397&subsub=8140'" style="cursor: pointer; display: inline-block; font-weight: bold;">
                        L series                     </li>
                                                               <li style="display: inline-block; margin: 0 8px; color: #666;">&gt;</li>
                     <li onClick="window.location='firmware.php?cat=12&sub=1397&subsub=8140&subsubsub=4985" style="cursor: pointer; display: inline-block; font-weight: bold;">
                        LE8                     </li>
                                       </ul>
               </div>
            </div>
         ...
         <section class="download_fld_sec">
            <div class="container">
               <div class="download_fld_secinner">
                  <div class="download_fld_sec_top" onClick="window.location='firmware.php?cat=12&sub=1397&subsub=8140'">
                     <div class="icon_area">
                        <a href="#">
                  ...
                  <div class="download_fld_sec_body">
                           ...
                           <div class="row">
                              <div class="col-md-12">
                                    ...
                                    <h3>LE8-H771B-R-GL-220902V1114.zip</h3>
                                 </div>
    ...
    box-shadow: 0 0 2px rgba(0, 0, 0, 0.2);
                                        ...
                                        <!-- Facebook -->
                                        <a href="https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Fgetwayrom.com%2Ffirmwares.php%3Ffirm%3D28436"
                                           onclick="incrementShare('facebook', '28436')" target="_blank"
                                           class="social-button">
                                        ...
                                        <!-- Twitter -->
                                        <a href="https://twitter.com/intent/tweet?url=https%3A%2F%2Fgetwayrom.com%2Ffirmwares.php%3Ffirm%3D28436"
                                           onclick="incrementShare('twitter', '28436')" target="_blank"
                                           class="social-button">
                                        ...
                                        <!-- Pinterest -->
                                        <a href="https://pinterest.com/pin/create/button/?url=https%3A%2F%2Fgetwayrom.com%2Ffirmwares.php%3Ffirm%3D28436"
                                           onclick="incrementShare('pinterest', '28436')" target="_blank"
                                           class="social-button">
                                 ...
                                 <div class="download_fld_sec_list_area">
                                    <ul class="download_fld_sec_list">
                                       <li><strong>Date :</strong> 2026-03-08 22:29:02 </li>
                                       <li>
                                       ...
                                       <li style="font-size:18px;"><strong>File Size :</strong> <span style="color: red;">4.19 GB</span></li>
                                                                              <li style="font-size:18px;"><strong>Downloads :</strong> 2</li>
                                       <li style="font-size:18px;"><strong>Visit :</strong> 21</li>
                                    </ul>
                                 </div>
                                 ...
                                 <!--    -->
                                 <!--        <a href="login.php?id=28436" class="download_btn right_download_btn" style="background: #262626;">-->
